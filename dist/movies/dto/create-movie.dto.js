...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'Inception', maxLength: 255 }),
...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'Christopher Nolan', maxLength: 150 }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsNotEmpty)(),
...
__decorate([
    (0, swagger_1.ApiProperty)({ enum: movie_entity_1.Genre, example: movie_entity_1.Genre.SCIFI }),
    (0, class_validator_1.IsEnum)(movie_entity_1.Genre),
    __metadata("design:type", String)
], CreateMovieDto.prototype, "genre", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: 2010, minimum: 1888, maximum: 2030 }),
...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 8.8, minimum: 0, maximum: 10 }),
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: 'A thief who steals corporate secrets...' }),
    (0, class_validator_1.IsString)(),
